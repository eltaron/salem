...
<div class="breadcrumbs">
        ...
        <div class="page-header float-left">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">جميع المهام والمواعيد المعلقة</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="page-header">
            <div class="page-title">
                <h1>جميع المهام والمواعيد المعلقة</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="card text-right" dir="rtl">
                <div class="card-header">
                    <strong class="card-title">جميع المهام والمواعيد المعلقة</strong>
                                    ...
                                    <tr>
                                        ...
                                        <td class="dropdown">
                                            ...
                                            <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <button  class="btn-block btn btn-warning activate_product" data-id="{{ $task->id }}">
                                                    <i class="fa fa-check-circle-o"></i>&nbsp; اتمام المهمه
                                                </button>
...
<div class="modal fade" id="activate_productModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                <h4 class="p-3 mb-4">هل حقا تريد انهاء الموعد ؟</h4>
                <div class="row" style="max-width: 170px; margin: 0 auto;">
                    <form action="{{aurl('tasks/activate')}}" method="POST">
                        @csrf
